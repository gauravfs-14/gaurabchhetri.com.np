...
export default function ProfileCard() {
  ...
  return (
    <div className="flex items-center">
      <Avatar className="w-28 h-28 hover:rotate-4 transition-transform duration-300 ease-in-out relative">
        <AvatarImage
        ...
        />
        <AvatarFallback className="hover:scale-105 transition-transform duration-300 ease-in-out">
          GC
        </AvatarFallback>
      </Avatar>
      <div className="flex flex-col ml-4 gap-1">
        ...
        <div className="text-muted-foreground mb-1">
          Full Stack Developer and Student Researcher
        </div>
        <div className="flex items-center">
